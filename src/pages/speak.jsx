...
export default function speaking() {
  return (
    <>
      <Head>
        <title>Speaking - Mustafa Mallebhari</title>
        <meta
          name="description"
          content="If you are looking for you a developer to speak!"
        />
      </Head>
      <SimpleLayout
        title="I love to share the joy of STEM+C"
        intro="If you are looking for your next guest speaking, I'm your girl! I am passionate about women in STEM+C, living life for the adventure, and navigating college as a non-traditional student."
      >
        <div className="space-y-20">
          <speakingSection title="Texas State University">
            ...
            <Appearance
              href=""
              title="Counter-Life Herstories Conference Guest speaking"
